...
/***/ "./src/admin/components/SSOwatSettingsModal.js":
/*!*****************************************************!*\
  !*** ./src/admin/components/SSOwatSettingsModal.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SSOwatSettingsModal; });
...
function (_SettingsModal) {
  ...
  var _proto = SSOwatSettingsModal.prototype;
...
/* harmony import */ var _components_SSOwatSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/SSOwatSettingsModal */ "./src/admin/components/SSOwatSettingsModal.js");


flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('tituspijean-auth-ssowat', function (app) {
  app.extensionSettings['tituspijean-auth-ssowat'] = function () {
    return app.modal.show(new _components_SSOwatSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});
